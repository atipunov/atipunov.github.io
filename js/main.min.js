...
value:"anton@tipunov.com"},location:{label:"Расположение",value:{locality:"Минск",country:"Беларусь"}},phone:{label:"Телефон",value:"+375 25 9419001"}}}),tipunovApp.controller("dashboardController",["$scope","profileService","$routeParams",function(e,t,n){e.locale=n.lang;var r=t.getProfile(e.locale);e.profile=r,e.page.setTitle(r.firstName+" "+r.lastName)}]),tipunovApp.run(["$rootScope",function(e){e.page={setTitle:function(e){this.title=e}},e.$on("$routeChangeSuccess",function(t,n){e.page.setTitle(n.$$route.title)})}]),tipunovApp.factory("profileService",["resources",function(e){function t(t){t&&e[t]||(t="en");var n=e[t];return n.social=[{className:"github",url:"https://github.com/atipunov",label:"GitHub",login:"atipunov"},{className:"linkedin",url:"https://www.linkedin.com/in/atipunov",label:"LinkedIn",login:"atipunov"},{className:"vk",url:"https://vk.com/tipunov1",label:"VK",login:"tipunov1"}],n}return{getProfile:t}}]),tipunovApp.directive("social",function(){return{restrict:"AE",replace:"true",template:'<li class="piece {{social.className}}">                        <a class="link" href="{{social.url}}" rel="me">                            <div class="icon"></div>                            <span class="service">{{social.label}}</span><span class="dash">/</span>                            <span class="login">{{social.login}}</span>                        </a>                    </li>'}});